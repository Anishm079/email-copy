...
This query refreshes whenever an order status changes for this user, _and_ polls every 60 seconds as a fallback to catch any updates that might not have a direct mutation trigger.
