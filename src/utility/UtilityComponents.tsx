    ...
    return (
      <div ref={ref}>
        <span>
          Hi {hrName},
          <br />
          <br />I am a Full Stack Developer with 3.5+ years of experience
          specialized in building secure, high-scale fintech and digital
          marketing platforms using{' '}
          <strong>
            TypeScript, Javascript, React.js, Node.js, Python, and Next.js.
          </strong>
          .
          <br />
          <br />
          ...
          >
            <li>
              <strong>High-Scale Marketing Systems:</strong> Engineered a
              Next.js and Redis-driven offer infrastructure serving{' '}
            ...
            <li>
              ...
              credit-processing speeds by <strong>15%</strong> by migrating
              legacy workflows into a real-time Socket.io Kanban dashboard, and
              natively consolidated the repayment lifecycle via custom NACH
          ...
          <br />
          <br />I have attached my resume for your review. I am actively
          interviewing and available to connect as early as possible.You can
          ...
          <strong>
            ...
            <br />
            <a href="https://github.com/Anishm079">github.com</a> |{' '}
            <a href="https://www.linkedin.com/in/anish-mulla-511b391b2/">
              linkedin.com
            </a>
          </strong>
        </span>
    ...
    return (
      <div ref={ref}>
        <span>
          ...
          <br />
          <br />
          This is Anish. I came across the {profile} opening on{' '}
          {!source ? source : 'LinkedIn'} and would like to apply for the role.
          <br />
          <br />
          <strong>
            I am a Full Stack Developer with 3.5+ years of experience
            specialized in building secure, high-scale fintech and digital
            marketing platforms using TypeScript, Javascript, React.js, Node.js,
            Python, and Next.js.
          </strong>
          <br />
          <br />
